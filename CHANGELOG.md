...
For a full diff see [`4.4.1...main`][4.4.1...main].

### Changed

- Stopped removing `v` prefixes from version constraints ([#1045]), by [@localheinz]
...
[4.4.1...main]: https://github.com/ergebnis/json-normalizer/compare/4.4.1...main
...
[#1045]: https://github.com/ergebnis/json-normalizer/pull/1045
