...
/**
 * @covers \Ergebnis\Json\Normalizer\Rule\Sort\PropertiesByName
 *
 ...
 */
final class PropertiesByNameTest extends Test\Util\AbstractRuleTestCase
{
    protected static function rule(): Rule
    {
        return Rule\Sort\PropertiesByName::create();
    }
}
