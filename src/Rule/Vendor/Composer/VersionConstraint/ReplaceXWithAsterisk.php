...
final class ReplaceXWithAsterisk implements Rule
{
    ...
    {
        return Rule\Name::fromString('vendor/composer/version-constraint/replace-x-with-asterisk');
    }
...
JSON,
    ...
    public function apply(
        ...
        $normalized = Constraints::applyToVersionsInTurn(
            Constraints::applyToVersionsInTurn(
                Constraints::applyToVersionsInTurn(
                    $versionConstraint,
                    '{^(\d+)\.[xX]\.[xX]$}',
                    '$1.*',
