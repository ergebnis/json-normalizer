...
final class RemoveDuplicates implements Rule
{
    ...
    {
        return Rule\Name::fromString('vendor/composer/version-constraint/remove-duplicates');
    }
...
JSON,
    ...
    public function apply(
        ...
        $normalized = Constraints::joinOrConstraints(...\array_unique(\array_map(static function (string $orConstraint): string {
            return Constraints::joinAndConstraints(...\array_unique(Constraints::splitIntoAndConstraints($orConstraint)));
